...
CREATE TABLE `Dictamen` (
  `IdDictamen` int(9) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `Dictamen` VALUES (1,'Aprobado por unanimidad con felicitación públ'),(2,'Aprobado por unanimidad'),(3,'Aprobado por mayoría'),(5,'En Proceso'),(6,'Recesion');
...
-- Dump completed on 2020-08-11 17:52:53
